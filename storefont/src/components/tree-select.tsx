...
>(({
    ...
    const expandedItemIds = React.useMemo(() => {
        ...
        function walkTreeItems(items: TreeDataItem[] | TreeDataItem, targetId: string) {
            ...
            } else if (!expandAll && items._id === targetId) {
                return true;
                    ...
                    <li key={item._id}>
                        {item.children ? (
                            <AccordionPrimitive.Root type="multiple" defaultValue={expandedItemIds}>
                                <AccordionPrimitive.Item value={item._id}>
                                    <AccordionTrigger
                                        className={cn(
                                            ...
                                            selectedItemId === item._id && "before:opacity-100 before:bg-accent text-accent-foreground before:border-l-2 before:border-l-accent-foreground/50 dark:before:border-0"
                                        )}
